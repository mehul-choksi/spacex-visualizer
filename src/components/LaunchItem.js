...
const LaunchItem = (props) => {
        ...
        const {image_url, mission_name,launch_date,launch_year, rocket_type, launch_site, launch_success} = props.launch;

        return (
            <div className="zoom">
                <div className= "card text-center" style={{borderRadius: '10px'}}>
                    <div style={{pointerEvents: "none"}}>
                        <img src={image_url} alt={noimg} className="round-img" style ={{width:"100px"}}/>
